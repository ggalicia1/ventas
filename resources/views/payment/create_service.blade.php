        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form id="form-paymet" action="{{ route('services.paymentService', $objet->id) }}" method="POST">
                        @csrf
...
<script>
    document.getElementById('form-paymet').addEventListener('submit', function(e) {
        ...
        fetch("{{ route('services.paymentService', $objet->id) }}", {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            ...
            if(data.status){
                Swal.fire({
                    ...
                    window.location.href = "{{ route('services.show', $objet->id) }}"; 
                });
            }else{
                Swal.fire({
                    icon: 'error',
