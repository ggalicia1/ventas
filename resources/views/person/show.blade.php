<x-app-layout>
    ...
    <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
        <div class="mt-4">
            <a href="{{ route('persons.index') }}" class="text-blue-600 hover:underline">Volver a persona</a>
        </div>
        <div class="container mx-auto px-6 py-8">
            <h2 class="text-2xl font-bold mb-6">Detalle de pagos de {{ $person->name }}</h2>
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                ...
                <div class="lg:w-1/3 p-4 rounded">
                    ...
                    <form method="GET" action="{{ route('persons.show', $person->id) }}" class="flex flex-col space-y-4">
                        <div>
                ...
                <div class="lg:w-2/3 bg-white px-6 py-6 rounded shadow">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="{{ route('persons.payment.create', $person->id) }}" class="bg-blue-600 text-white px-4 py-2 rounded shadow hover:bg-blue-500 transition">
                            Nuevo pago
                        </a>
                    </div>
